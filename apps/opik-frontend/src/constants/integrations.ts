...
import functionDecoratorsCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/FunctionDecorators.py?raw";
import openAiCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/OpenAI.py?raw";
import anthropicCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/Anthropic.py?raw";
import bedrockCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/Bedrock.py?raw";
import geminiCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/Gemini.py?raw";
import groqCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/Groq.py?raw";
import langChainCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/LangChain.py?raw";
import langGraphCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/LangGraph.py?raw";
import llamaIndexCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/LlamaIndex.py?raw";
import haystackCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/Haystack.py?raw";
import liteLLMCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/LiteLLM.py?raw";
import ragasCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/Ragas.py?raw";
import dspyCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/DSPy.py?raw";

import { integrationLogsMap } from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-logs";

import ollamaCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/Ollama.py?raw";
...
import guardrailsaiCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/GuardrailsAI.py?raw";
import predibaseCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/Predibase.py?raw";
// import pydanticaiCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/PydanticAI.py?raw";
// import smolagentsCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/Smolagents.py?raw";
import { buildDocsUrl } from "@/lib/utils";
// import strandsAgentsCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/StrandsAgents.py?raw";
// import vercelAiCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/VercelAI.py?raw";
// import watsonxCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/WatsonX.py?raw";
// import openAIAgentsCode from "@/v1/pages-shared/onboarding/FrameworkIntegrations/integration-scripts/OpenAIAgents.py?raw";
